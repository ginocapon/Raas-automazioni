...
- **Mai lasciare in pubblicazione** URL di aggregatori concorrenti (es. europainnovazione.com): bonifica con `tools/resolve-europainnovazione-urls.js` + eventuale `tools/sql/deactivate-europainnovazione-remaining.sql` (stessa skill, sezione dedicata).
